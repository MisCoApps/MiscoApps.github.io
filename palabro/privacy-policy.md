...
PalaBro **no requiere registro ni cuenta de usuario**. Nosotros no
recogemos ni almacenamos en servidores propios:
...
Algunos proveedores externos (Google) sí tratan ciertos datos técnicos
de tu dispositivo cuando se muestran anuncios, se informa de fallos o se
sincronizan los logros. Esto se detalla en las secciones 5, 7 y 8.

## 3. Datos que se almacenan localmente en tu dispositivo

Toda la información de juego se guarda **únicamente en tu dispositivo**
mediante almacenamiento local (Hive). No se transmite a ningún servidor
controlado por nosotros. Incluye:
...
PalaBro muestra anuncios mediante **Google AdMob** para sostener el
desarrollo. AdMob es un servicio de Google LLC. Para servir los
anuncios, AdMob puede recoger los siguientes datos desde tu dispositivo:

- **Identificador publicitario** (Advertising ID en Android, IDFA en
  iOS): un código no permanente que el usuario puede resetear o
  desactivar desde los ajustes del sistema.
...
Estos datos los recoge y procesa Google directamente, no nosotros. La
política de privacidad y los controles de Google se encuentran en:
...
- **En el Espacio Económico Europeo, Reino Unido y Suiza:** la primera
  vez que abres la aplicación, mostramos un formulario de consentimiento
  (Google UMP) donde puedes aceptar anuncios personalizados o limitarte
  a anuncios no personalizados. Puedes cambiar o revocar tu elección en
  cualquier momento desde **Ajustes de la aplicación → "Gestionar
  consentimiento"**, o desde los ajustes publicitarios del sistema.
...
- **Resto del mundo:** se sirven anuncios personalizados por defecto,
  con la opción de optar por no recibirlos modificando los ajustes
  publicitarios del sistema operativo.

## 6. Anuncios recompensados

La aplicación ofrece anuncios opcionales que el usuario puede ver
voluntariamente para obtener monedas, una pista extra o recuperar una
racha diaria perdida. Estos anuncios son **iniciados por el usuario**
(nunca forzados) y siguen las mismas reglas de AdMob descritas arriba.

## 7. Informes de fallos (Firebase Crashlytics)
...
no se emplean con fines publicitarios ni se venden a terceros. No
recogemos a través de Crashlytics datos personales identificables. La
recogida está desactivada en las versiones de desarrollo. Más
información: [https://firebase.google.com/support/privacy](https://firebase.google.com/support/privacy).

## 8. Logros (Google Play Juegos)
...
Futuras versiones pueden añadir una opción para comprar paquetes de
monedas o pistas; en ese caso, las compras se procesan a través de
**Apple App Store** (iOS) o **Google Play** (Android) y se rigen por sus
respectivas políticas. Nosotros no recibimos datos de tarjeta ni de pago
— solo recibimos confirmación de que la compra se realizó.
...
- **Acceso:** saber qué datos tenemos sobre ti (en nuestro caso,
  ninguno almacenado por nosotros, porque todo es local en tu
  dispositivo).
- **Rectificación:** corregir datos inexactos.
- **Supresión ("derecho al olvido"):** desinstala la aplicación o borra
  sus datos desde los ajustes del sistema; eso elimina todo lo que
  almacenamos localmente.
- **Oposición y limitación del tratamiento:** revoca el consentimiento
  de AdMob desde **Ajustes de la aplicación → "Gestionar consentimiento"**
  o desde el sistema operativo, o desinstala la aplicación.
- **Portabilidad:** no aplicable, ya que no almacenamos tus datos en
  nuestros servidores.
...
AdMob, Firebase Crashlytics y Play Juegos son servicios de Google LLC,
con sede en Estados Unidos. Los datos que estos servicios recogen pueden
ser transferidos y procesados fuera del Espacio Económico Europeo. Google
cuenta con cláusulas contractuales tipo aprobadas por la Comisión Europea
...
La comunicación con AdMob, Crashlytics y Play Juegos se realiza mediante
HTTPS.
